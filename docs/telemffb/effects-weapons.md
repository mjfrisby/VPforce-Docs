...
<!-- telemffb-effect name=countermeasure_effect_enabled part=badges -->

A thump for each chaff or flare release.

<!-- telemffb-effect name=countermeasure_effect_enabled part=table -->

## Gunfire

<!-- telemffb-effect name=gunfire_effect_enabled part=badges -->

Vibration while guns are firing.

<!-- telemffb-effect name=gunfire_effect_enabled part=table -->

## Weapons Release

<!-- telemffb-effect name=weapon_release_effect_enabled part=badges -->

A jolt as ordnance comes off the rails or racks.

<!-- telemffb-effect name=weapon_release_effect_enabled part=table -->

## Weapon Effects Direction
